...
docker build --target setup-server -t setup_server:0.0.1 .
docker tag      setup_server:0.0.1 justushibshman/jih_personal:setup_server-0.0.1
docker push                        justushibshman/jih_personal:setup_server-0.0.1
