...
docker build --target setup-server -t setup_server:0.1.26 .
docker tag      setup_server:0.1.26 justushibshman/jih_personal:setup_server-0.1.26
minikube image load justushibshman/jih_personal:setup_server-0.1.26
