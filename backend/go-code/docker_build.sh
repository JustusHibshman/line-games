...
docker build --target setup-server -t setup_server:0.1.30 .
docker tag      setup_server:0.1.30 justushibshman/jih_personal:setup_server-0.1.30
minikube image load justushibshman/jih_personal:setup_server-0.1.30
