...
docker build --target setup-server -t setup_server:0.1.10 .
docker tag      setup_server:0.1.10 justushibshman/jih_personal:setup_server-0.1.10
docker push                         justushibshman/jih_personal:setup_server-0.1.10
