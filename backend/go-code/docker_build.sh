...
docker build --target gameplay-server -t gameplay_server:0.1.2 .
docker tag      gameplay_server:0.1.2 justushibshman/jih_personal:gameplay_server-0.1.2
minikube image load justushibshman/jih_personal:gameplay_server-0.1.2
  # docker push                        justushibshman/jih_personal:gameplay_server-0.1.0
